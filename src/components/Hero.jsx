    ...
    return (
        <section className="hero">
            <div className="hero-text">
                ...
                <p className="hero-intro">Tidigare har jag arbetat som folkhögskollärare, mentor och hälsopedagog. Jag kan lite om mycket och har aldrig slutat plugga nya saker under tiden jag jobbat. Dialekter och ortnamn, religionsfilosofi, brukspiano och musikteater är några små stickspår som givit mig nya insikter. Lindy hop och improvisationsteater har följt med länge.
                </p>
